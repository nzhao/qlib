function [M,N,M2,N2,M3,N3,M4,N4] = vswfcart1(n,m,kr,theta,phi,htype)
import ott13.*
...
% [M1,N1,M2,N2,M3,N3,M4,N4] = vswfsph2cart(n,m,kr,theta,phi)
...
if nargin < 6
   ...
   htype = 0;% htype 0 is "type=3"

end



[M,N,M2,N2,M3,N3,M4,N4] = vswf1(n,m,kr,theta,phi,htype);
