classdef CCE_Clustering1 < model.phy.SpinCollection.Iterator.ClusterIteratorGen.AbstractClusterIteratorGen
    ...
    methods
        function obj=CCE_Clustering1(spin_collection, parameters)
